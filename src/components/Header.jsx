        ...
        return (
            <header className="header">
                <div className="header-container">
                    ...
                    <div className={`search-bar${screenSize('width') < 560 ? ' has-search-menu' : ''}`}>
                        {screenSize('width') < 560 && <span className="search-menu" onClick={()=> {this.setState({searchMenu: !this.state.searchMenu})}}>
                            <i className="icon-search"></i>
                        </span>}
                        <div className="search-form" style={screenSize('width') < 560 && !this.state.searchMenu ? {display: 'none'} : {}}>
                    ...
                    <div className={`custom-dropdown user-bar ${this.state.profileMenu}`}>
                        ...
                        {screenSize('width') > 767 && <div className="user-name">
